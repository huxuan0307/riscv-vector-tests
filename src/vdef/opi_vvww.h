...
#define VOPI_VVWW_IUI_DEF VOPI_VVWW_DEF
...
#define VOPI_VVWW_IUI_M_DEF VOPI_VVWW_M_DEF
...
#define VOPI_VVWW_IU_DEF_GROUP_IMPL(op) \
...
#define VOPI_VVWW_IUI_DEF_GROUP(op) VOPI_VVWW_IU_DEF_GROUP_IMPL(op ## _VV_IU_DEF)
...
#define VOPI_VVWW_IUI_M_DEF_GROUP(op) VOPI_VVWW_IU_DEF_GROUP_IMPL(op ## _VV_IU_M_DEF)
...
#define VWMACCSU_VV_IU_DEF(type2, type1, lmul_arg, type_ret, lmul_ret)  VOPI_VVWW_IUI_DEF(vwmaccsu, type2, type1, lmul_arg, type_ret, lmul_ret)

VOPI_VVWW_III_DEF_GROUP(VWMACC)
VOPI_VVWW_UUU_DEF_GROUP(VWMACCU)
VOPI_VVWW_IUI_DEF_GROUP(VWMACCSU)
...
#define VWMACCSU_VV_IU_M_DEF(type2, type1, lmul_arg, type_ret, lmul_ret)  VOPI_VVWW_IUI_M_DEF(vwmaccsu, type2, type1, lmul_arg, type_ret, lmul_ret)

VOPI_VVWW_III_M_DEF_GROUP(VWMACC)
VOPI_VVWW_UUU_M_DEF_GROUP(VWMACCU)
VOPI_VVWW_IUI_M_DEF_GROUP(VWMACCSU)
