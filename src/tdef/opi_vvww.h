...
#define TEST_OPI_VVWW_IUI TEST_OPI_VVWW
...
#define TEST_OPI_VVWW_IUI_M TEST_OPI_VVWW_M
...
#define TEST_OPI_VVWW_IUI_GROUP_IMPL(test, op) \
...
#define TEST_OPI_VVWW_IUI_GROUP(op)    TEST_OPI_VVWW_IUI_GROUP_IMPL(TEST_OPI_VVWW_IUI, op)
...
#define TEST_OPI_VVWW_IUI_M_GROUP(op)  TEST_OPI_VVWW_IUI_GROUP_IMPL(TEST_OPI_VVWW_IUI_M, op)
