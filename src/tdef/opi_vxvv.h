...
test_opi_vxvv<type_ret, type2, type1>(op ## _vx_ref<type_ret, type2, type1>, op ## _vx_## type_ret ## lmul ## _vec)

#define TEST_OPI_VXVV_M(op, type2, type1, type_ret, lmul) \
printf("\ntest " #op "_vx_" #type_ret #lmul "_m" " ...\n"); \
test_opi_vxvv_m<type_ret, type2, type1>(op ## _vx_m_ref<type_ret, type2, type1>, op ## _vx_## type_ret ## lmul ## _m_vec)
