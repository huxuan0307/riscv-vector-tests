...
VOPI_VXV_REF_DEF(vsll,           FORLOOP(i, vd[i] = vs2[i]<<(rs1[0] & (sizeof(rs1[0])*8-1))))
VOPI_VXV_REF_DEF(vsrl,           FORLOOP(i, vd[i] = vs2[i]>>(rs1[0] & (sizeof(rs1[0])*8-1))))
VOPI_VXV_REF_DEF(vsra,           FORLOOP(i, vd[i] = vs2[i]>>(rs1[0] & (sizeof(rs1[0])*8-1))))
