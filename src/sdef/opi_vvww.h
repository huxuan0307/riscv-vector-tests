...
VOPI_VVWW_REF_DEF(vwmacc,   FORLOOP(i, vd[i] = +(static_cast<TypeRet>(vs1[i]) * static_cast<TypeRet>(vs2[i])) + vd[i]))
VOPI_VVWW_REF_DEF(vwmaccu,  FORLOOP(i, vd[i] = +(static_cast<TypeRet>(vs1[i]) * static_cast<TypeRet>(vs2[i])) + vd[i]))
VOPI_VVWW_REF_DEF(vwmaccsu, FORLOOP(i, vd[i] = +(static_cast<TypeRet>(vs1[i]) * static_cast<std::make_unsigned_t<TypeRet>>(vs2[i])) + vd[i]))
